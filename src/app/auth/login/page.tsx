...
function LoginForm() {
  ...
  const displayError = error || (urlError === "OAuthAccountNotLinked" 
  ...
  return (
    <main className="min-h-screen flex flex-col px-6 py-8">
      {/* Back Button */}
      <Link href="/" className="flex items-center text-gray-600 mb-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Log in to access your recipes</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 flex-1">
        ...
        <button
          ...
          disabled={isLoading}
          className="w-full flex items-center justify-center gap-3 py-3 px-6 border border-gray-300 rounded-xl hover:bg-gray-50 transition-colors disabled:opacity-50"
        >
